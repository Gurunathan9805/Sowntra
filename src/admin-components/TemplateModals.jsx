    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full mx-4 border border-gray-100 max-h-[90vh] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
        ...
        <div className="p-6 space-y-5">
          ...
          {/* Template Type - RENAMED FROM VISIBILITY */}
          <div>
            <label className="block text-sm font-medium mb-2 text-gray-700">
              Template Type
            </label>
          ...
          {/* Access Type Toggle - UPDATED LABEL */}
          <div>
            <label className="block text-sm font-medium mb-2 text-gray-700">
              Pricing Tier
            </label>
            <div className="flex items-center justify-between bg-gray-50 p-3 rounded-xl border border-gray-200">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs text-gray-500">
                  {uploadData.isPremium ? "(Subscription required)" : "(Free to use)"}
                </span>
              </div>
          ...
          {/* Upload Files - UPDATED ACCEPT TYPES */}
          <div>
            <label className="block text-sm font-medium mb-2 text-gray-700">
              Template Files
            </label>
          ...
          {/* Upload Button - UPDATED VALIDATION */}
          <button
            onClick={handleUpload}
            disabled={!uploadData.name.trim() || !uploadData.category}
          ...
          {(!uploadData.name.trim() || !uploadData.category) && (
            <p className="text-xs text-red-500 text-center">
              * Template name and category are required
            </p>
          )}
        </div>
      </div>
